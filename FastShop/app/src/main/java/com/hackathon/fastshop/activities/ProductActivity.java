...
import com.hackathon.fastshop.apicaller.ApiCaller;
...
public class ProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        qrButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                IntentIntegrator integrator = new IntentIntegrator(ProductActivity.this);
    ...
    protected void onNewIntent(Intent intent) {
        ...
        intents.put(bytesToHexString(myTag.getId()), new IntentDto(bytesToHexString(myTag.getId()), data));
    ...
    private void generateProducts(){
        products.put("0x39f52c7d", new ProductDto("0x39f52c7d", "Bere", BigDecimal.valueOf(75)));
        products.put("0x39e8337d", new ProductDto("0x39e8337d", "Canta", BigDecimal.valueOf(125)));
        products.put("0x49ccd87d", new ProductDto("0x49ccd87d", "Bot", BigDecimal.valueOf(2775)));
        products.put("0xa7b43e65", new ProductDto("0xa7b43e65", "Atki", BigDecimal.valueOf(125)));
        products.put("0xc712b865", new ProductDto("0xc712b865", "Tshirt", BigDecimal.valueOf(250)));
    }
